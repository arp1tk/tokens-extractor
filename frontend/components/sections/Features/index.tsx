...
export default function Features() {
  ...
  return (
    <div
      className="container !py-[72px] max-[860px]:!py-12"
      id="features"
    ...
    >
      ...
      <div className="card-grid-holder">
        <div className="w-layout-grid card-grid">
          <div className="colored-block !justify-start">
            ...
            <div className="card-image-holder flex flex-auto items-center justify-center p-[8px_25px_25px]" data-anim="4">
              <Image
                className="card-image !h-auto !w-auto max-h-[300px] max-w-full object-contain"
          ...
          <div className="colored-block !justify-start">
            ...
            <div className="card-image-holder flex flex-auto items-center justify-center p-[8px_25px_25px]" data-anim="7">
        ...
        <div className="w-layout-grid card-grid reverse">
          <div className="colored-block !justify-start">
            ...
            <div className="card-image-holder flex flex-auto items-center justify-center p-[8px_25px_25px]" data-anim="10">
              <Image
                className="card-image !h-auto !w-auto max-h-[300px] max-w-full object-contain"
          ...
          <div className="colored-block !justify-start">
            ...
            <div className="card-image-holder flex flex-auto items-center justify-center p-[8px_25px_25px]" data-anim="13">
              <Image
                className="card-image !h-auto !w-auto max-h-[300px] max-w-full object-contain"
